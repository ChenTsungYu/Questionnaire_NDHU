...
class AppWindow(QDialog):
    ...
    # def log(self, course_name, course_code):
    #     course_info = f"課程名稱: {course_name}\n課程代碼: {course_code}"
    #     return course_info
    def send_info(self):
        ...
        # self.ui.listWidget.addItem(self.log('PyQt5教學', 10))  # 顯示在我們剛建立的 List Widget內
        self.ui.listWidget.scrollToBottom()  # 這行很重要，如果你沒加這行，你的如果超過self.displayListWidget範圍的話，他是不會往下執行的
